...
FLAG_adaptive_query_space = True
adaptive_query_space_info = {'growth_time_stamps': 'linear', 'max_iter_growth': 16, 'growth_factor': 1}
...
if FLAG_simulator:
    SAVE_DIR = policy_type + '_mle_sim_linear_qs_%03d' % expt_number
else:
    SAVE_DIR = policy_type + '_mle_expt_linear_qs_%03d' % expt_number

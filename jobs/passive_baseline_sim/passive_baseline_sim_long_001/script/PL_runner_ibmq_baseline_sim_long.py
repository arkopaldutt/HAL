...
if FLAG_simulator:
    SAVE_DIR = policy_type + '_baseline_sim_long_%03d' % expt_number
else:
    SAVE_DIR = policy_type + '_baseline_expt_long_%03d' % expt_number
...
PL_baseline_expt_run = partial(job_helper.passive_learner_expt, max_iter=max_iter, env_qs=oracle_qs_sim,
...
if __name__ == '__main__':
    results_passive_learner = PL_baseline_expt_run(args.run_seed)
